...
namespace Microsoft.Azure.EventHubs
{
    ...
    class SharedAccessSignatureToken : SecurityToken
    {
        ...
        public SharedAccessSignatureToken(string tokenString)
            : base(tokenString, DateTime.MinValue, "tmp", ClientConstants.SasTokenType)
        {
            if (tokenString == null)
            {
            ...
            this.tokenType = ClientConstants.SasTokenType;
        ...
        public SharedAccessSignatureToken(string tokenString, DateTime expiresAtUtc)
            : base(tokenString, expiresAtUtc, GetAudienceFromToken(tokenString), ClientConstants.SasTokenType)
        {
        }
